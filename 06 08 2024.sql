...
create table estado(id int(2) primary key auto_increment,nome varchar(60));
...
create table marca (id int(1)primary key auto_increment,nome varchar(30));
...
create table categoria (id int(1)primary key auto_increment,nome varchar(40));
...
create table cliente(id int(2) primary key auto_increment,nome varchar(60),email varchar(60),CPF varchar(15),data_nasc date,idcidadeFK int(2),idestadoFK int(2),
constraint clienteCidade foreign key (idcidadeFK) references cidade(id),
constraint clienteEstado foreign key (idestadoFK) references estado(id)
);
...
create table vendedor(id int(2) primary key auto_increment,nome varchar(60),email varchar(60),CPF varchar(15),idcidadeFK int(2),idestadoFK int(2),
constraint vendedorCidade foreign key (idcidadeFK) references cidade(id),
constraint vendedorEstado foreign key (idestadoFK) references  estado(id)
);
...
create table pedido(id int(2) primary key auto_increment,data_pedido date,idvendedorFK int(2),idclienteFK int(2),
constraint pedidoVendedor foreign key (idvendedorFK) references vendedor(id),
constraint pedidoCliente foreign key (idclienteFK) references cliente(id)
);
...
create table produto(id int(2) primary key auto_increment,idcategoriaFK int(1),idmarcaFK int(1),nome varchar(80),preco float(10,2),
constraint produtoCategoria foreign key (idcategoriaFK) references categoria(id),
constraint produtMarca foreign key (idmarcaFK) references marca(id)
 );
...
create table itens_pedido(id int(2) primary key auto_increment,idpedidoFK int(2),idprodutoFK int(2),qtde int(2),valor_unit float(10,2),valor_total float(10,2),
constraint itens_pedidosPEDIDO foreign key  itens_pedido(idpedidoFK) references pedido(id),
constraint itens_pedidosPRODUTO foreign key  itens_pedido(idprodutoFK) references produto(id)
);
...
INSERT INTO itens_pedido VALUES (null,9,22,4,9.50,38.00);
